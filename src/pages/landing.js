      ...
      <article class="max-w-7xl h-20 mx-auto flex items-center justify-between">
        <div class="flex items-center space-x-3">
          <article class="w-20 h-20 m-4 relative cursor-pointer">
            <img src="../assets/Icono.svg" class="w-full h-full">
          </article>
          <img src="../assets/logo_color.svg" class="w-35 h-40 m-4">
        </div>
    ...
    <div class="max-w-5xl mx-auto text-center">
      <!-- Flor central -->
        <article id="logoHero" class=""w-40 h-40 mx-auto mb-6 logo-animate cursor-pointer">
            <img src="../assets/Icono.svg" alt="logo artemisa" class="w-40 h-40 mx-auto mb-6">
        </article>
      ...
      <div class="flex items-center justify-center">
                    ...
                    <div class="w-50 ml-1.5">
                        ...
                        <img src="../assets/logo_color.svg" alt="logo de artemisa " class="w-full" >
                    </div>
                </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <article class="w-50 rounded-lg shadow-lg p-6 bg-white border-t-4 border-[#f56d95]">
        <div class="w-16 h-16 mx-auto mb-4 flex items-center justify-center">
          <img src="../assets/icono_voluntariado.svg" alt="icono voluntariado" class="w-40 h-40">
        </div>
      ...
      <article class="w-50 rounded-lg shadow-lg p-6 bg-white border-t-4 border-[#f6c6fa]">
        <div class="w-16 h-16 mx-auto mb-4 flex items-center justify-center">
          <img src="../assets/comunidad.png" alt="icono de comunidad" class="w-15 h-20">
        </div>
      ...
      <article class="w-50 rounded-lg shadow-md p-6 bg-white border-t-4 border-[#f56d95]">
        <div class="w-16 h-16 mx-auto mb-4 flex items-center justify-center">
          <img src="../assets/icono_eventos.svg" alt="icono de eventos" class="w-40 h-40">
        </div>
      ...
      <article class="w-50 rounded-lg shadow-md p-6 bg-white border-t-4 border-[#f6c6fa]">
        <div class="w-16 h-16 mx-auto mb-4 flex items-center justify-center">
          <img src="../assets/icono_apoyo.svg" alt="icono de apoyo" class="w-40 h-40">
        </div>
...
<footer class="bg-[#f56d95] py-6 px-4">
  <div class="max-w-3xl mx-auto text-center">
    <img src="../assets/logo_blanco.svg" alt="logo artemisa blanco" class="w-28 h-auto mx-auto">
    <div class="border-t border-white/30 pt-4 mt-4">
      <div class="flex justify-center space-x-4">
        <a href="#" class="text-white hover:text-pink-200 transition-colors">
          <img src="../assets/icono_linkedin.svg" alt="LinkedIn" class="w-8 h-8">
        </a>
        <a href="#" class="text-white hover:text-pink-200 transition-colors">
          <img src="../assets/icono_ig.svg" alt="Instagram" class="w-8 h-8">
        </a>
