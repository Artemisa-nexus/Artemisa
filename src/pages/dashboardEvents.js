       ...
       <main class="flex-1 p-6">
            <div class="flex-1 p-6">
                ...
                <section class="flex items-center justify-between mb-6">
                    <h1 class="text-3xl font-semibold text-[#f56d95]">Proximos eventos</h1>
                    <button class="bg-[#f56d95] text-white px-6 py-2 rounded-lg font-medium hover:bg-[#f84e81] transition-colors">
                        Add Events
                    </button>
                </section>
